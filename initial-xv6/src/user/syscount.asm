...
0000000000000000 <main>:
  ...
  24:	dd058593          	addi	a1,a1,-560 # df0 <malloc+0x148>
  28:	4509                	li	a0,2
  2a:	00001097          	auipc	ra,0x1
  2e:	a34080e7          	jalr	-1484(ra) # a5e <fprintf>
  32:	4505                	li	a0,1
  34:	00000097          	auipc	ra,0x0
  38:	532080e7          	jalr	1330(ra) # 566 <exit>
  3c:	fd043783          	ld	a5,-48(s0)
  40:	07a1                	addi	a5,a5,8
  42:	639c                	ld	a5,0(a5)
  44:	853e                	mv	a0,a5
  46:	00000097          	auipc	ra,0x0
  4a:	326080e7          	jalr	806(ra) # 36c <atoi>
  4e:	87aa                	mv	a5,a0
  50:	fef42623          	sw	a5,-20(s0)
  54:	fec42783          	lw	a5,-20(s0)
  58:	853e                	mv	a0,a5
  5a:	00000097          	auipc	ra,0x0
  5e:	5b4080e7          	jalr	1460(ra) # 60e <getsyscount>
  62:	87aa                	mv	a5,a0
  64:	0207d063          	bgez	a5,84 <main+0x84>
  68:	00001597          	auipc	a1,0x1
  6c:	db858593          	addi	a1,a1,-584 # e20 <malloc+0x178>
  70:	4509                	li	a0,2
  72:	00001097          	auipc	ra,0x1
  76:	9ec080e7          	jalr	-1556(ra) # a5e <fprintf>
  7a:	4505                	li	a0,1
  7c:	00000097          	auipc	ra,0x0
  80:	4ea080e7          	jalr	1258(ra) # 566 <exit>
  84:	fd043783          	ld	a5,-48(s0)
  88:	07c1                	addi	a5,a5,16
  8a:	6398                	ld	a4,0(a5)
  8c:	fd043783          	ld	a5,-48(s0)
  90:	07c1                	addi	a5,a5,16
  92:	85be                	mv	a1,a5
  94:	853a                	mv	a0,a4
  96:	00000097          	auipc	ra,0x0
  9a:	508080e7          	jalr	1288(ra) # 59e <exec>
  9e:	00001597          	auipc	a1,0x1
  a2:	da258593          	addi	a1,a1,-606 # e40 <malloc+0x198>
  a6:	4509                	li	a0,2
  a8:	00001097          	auipc	ra,0x1
  ac:	9b6080e7          	jalr	-1610(ra) # a5e <fprintf>
  b0:	4505                	li	a0,1
...
00000000000007f8 <vprintf>:
 ...
 972:	4ea78793          	addi	a5,a5,1258 # e58 <malloc+0x1b0>
